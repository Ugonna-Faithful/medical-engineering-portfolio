...
presented with its methods, code or data, and results.
...
Signal processing, algorithm development, designed experiments, and
optimisation.
*Current projects: surface EMG signal processing; factorial design of experiment.*

### [Quality Control & Regulatory Affairs](quality-control-regulatory-affairs/)
Standards mapping, risk management, and medical-device regulatory analysis.

### [Design Engineering](design-engineering/)
Mechanical CAD, circuit design, and device design for manufacture.

### [Validation](validation/)
Verification and validation methods, test protocols, and design assurance.

### [Clinical Engineering](clinical-engineering/)
Healthcare systems, clinical workflow, and the organisational context of medical
devices.

### [Engineering Management](engineering-management/)
Project planning, systems-level coordination, and engineering process.
