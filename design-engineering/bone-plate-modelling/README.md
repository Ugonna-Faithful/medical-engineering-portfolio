...
*Engineering drawing of the volar distal radius fixation plate: orthographic views, key dimensions, Section A-A through a hole, and distal-hole detail.*

<img src="figures/bone-plate-render.png" width="360" alt="Isometric render of the plate">

*Isometric render showing the T-shaped distal head with its locking-hole cluster, the compression slots along the shaft, and the countersunk holes.*
